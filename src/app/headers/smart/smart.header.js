...
var SmartHeaderComponent = (function () {
    function SmartHeaderComponent(route, service) {
        this.route = route;
        this.service = service;
    }
    SmartHeaderComponent.prototype.logout = function () {
        this.service.logout();
    };
    return SmartHeaderComponent;
}());
SmartHeaderComponent = __decorate([
    core_1.Component({
...
exports.SmartHeaderComponent = SmartHeaderComponent;
//# sourceMappingURL=smart.header.js.map